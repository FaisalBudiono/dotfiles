...
-- Search Err in Go
vim.keymap.set({ "n" }, "<leader>l`e", "/\\v\\C(\\.|\\s|\\(){1}Err<CR>", opts("Search err in Go with case sensitive"))
vim.keymap.set({ "n" }, "<leader>l`E", "/\\v(\\.|\\s|\\(){1}Err<CR>", opts("Search err in Go with case insensitive"))
